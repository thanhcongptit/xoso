...
function _fnGetCalendarMonth(iMonth)
{
	...
	/*
	oMonths.push('Tháng 1');
	oMonths.push('Tháng 2');
	oMonths.push('Tháng 3');
	oMonths.push('Tháng 4');
	oMonths.push('Tháng 5');
	oMonths.push('Tháng 6');
	oMonths.push('Tháng 7');
	oMonths.push('Tháng 8');
	oMonths.push('Tháng 9');
	oMonths.push('Tháng 10');
	oMonths.push('Tháng 11');
	oMonths.push('Tháng 12');
	*/
