    ...
    <head>
        ...
        <script>
            ...
            function checkTimeLive() {
                ...
                if (currHHMMSS >= 180500 && currHHMMSS < 183800) {
                    if (hourmb === '00' && minumb === '00' && secondmb === '00') {
                        hidenKQ('#kqmienbac');
                        hidenKQ('#d2mienbac');
                    }
...
//                    }
            ...
            function sapxep() {
                ...
                if (currHHMMSS > 163800 && currHHMMSS < 191100) {
                    ...
                    console.log('temp: ' + temp);
                    //conglt
                    //loadAjax(temp + '/ajax123/xsmn.html', 'kqmn_new');
                ...
                if (currHHMMSS > 173800 && currHHMMSS < 191100) {
                    ...
                    console.log('temp: ' + temp);
                    //conglt
                    //loadAjax(temp + '/ajax123/xsmt.html', 'kqmt_new');
                ...
                if (currHHMMSS > 183800 && currHHMMSS < 191100) {
                    ...
                    //conglt
                    //loadAjax(temp + '/ajax123/xsmb.html', 'kqmb_new');
                    loadXSLive('MB');
...
#content-center #content-tructiep td#tructiep {
	padding-top: 0px
}
                            ...
                            <table>
                                ...
                                <c:if test="${1<0}">
                                    ...
                                    <div class="box_kqxs box_cc" id="kqmiennam">
                                        <div id="kqxsmb">
                                            <div class="result-header">                           
                                                <h2 ><a href="${strUrl}/ket-qua-xo-so-mien-nam-xsmn.html" title="kết quả xổ số miền nam">KẾT QUẢ XỔ SỐ MIỀN NAM XSMN</a> Ngày ${lotterysMN.openDate}</h2>                                  
                                            </div>                        
                                            <div class="box_so">
                                                <table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#dedede">
                                                    <tbody>
				...
				<div class="banner-bt">
						<%
				            if(request.getRequestURI().endsWith("/index.jsp")){
				                Banner banner = new BannerDAO().find("index", Banner.POSITION_BOTTOM);
				                if(banner != null) out.print(banner.getCode());
				            }else{
				            	 Banner banner = new BannerDAO().find("other", Banner.POSITION_BOTTOM);
				                if(banner != null) out.print(banner.getCode());
				            }
				        %>
				</div>
