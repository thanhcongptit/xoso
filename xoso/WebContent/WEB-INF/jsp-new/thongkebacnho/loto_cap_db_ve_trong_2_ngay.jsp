...
<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<%@page import="com.soicaupro.thongkebacnho.domain.ScreenTwoDaySpecialDTO"%>
...
<%@page import="com.soicaupro.thongkebacnho.domain.LotoDacBiet2NgayDTO"%>
...
<%
            ...
            List<ScreenTwoDaySpecialDTO> results = (List<ScreenTwoDaySpecialDTO>) request.getAttribute("results");
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, Lotto cặp về trong 2 ngày theo đặc biệt)</h1>
                </div>
            </section>

            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/loto_cap_db_rs_ve_trong_2ngay.htm" accept-charset="UTF-8" class="" name="frm" autocomplete="off"><input name="_token" type="hidden" value="FliiCwtWxloRDGOEX1YgnmIIX9Bp9eWxhQJml2mn">
            ...
            <section class="sc-section">
                ...
                <center>
                    <div class="tb-tsc">
                        <p><center>Thống kê từ 01/01/2005 đến nay trong <%=numberDate%> lần ĐB về <%=special%> gần đây, 10 cặp loto về nhiều nhất trong 2 sau đó:</center></p>
                        <br />
                        <br />
                        ...
                        <table class="sc-table-tsc">
                            ...
                            <tbody>
                                <% if (results != null && results.size() > 0) {
                                        for (ScreenTwoDaySpecialDTO screenOneDayDTO : results) {%>
                                <tr>
                ...
                <center>
                    <br />
                    <br />
                    <p><center>Bảng thống kê chi tiết về trong 2 ngày </center></p>
                    <br />
                    <p>
                        <%
                            if (results != null && results.size() > 0) {
                                for (int i = 0; i < results.size(); i++) {
                                    ScreenTwoDaySpecialDTO dto = results.get(i);
                        %> 
                    ...
                    <br />
                    <div class="detail_loto" style="overflow: hidden;width:1050px">
                        <center>
                            ...
                            <div class="loto0_detail" style="width:200px;float:left;">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                    ...
                                    <thead>
                                        <tr>
                                            <td colspan="2" style="background-color:#CCFFCC;font-size:11px">Số lần về cụ thể từng ngày như sau</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="loto1_detail" style="width:240px;float:left;">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                        
                                        <col width="100px">
                                    ...
                                    <thead>
                                        <tr>
                                            <td style="background-color:#66CCFF;">----</td>                            <td colspan="2" style="background-color:#CCFFCC;font-size:11px">Số lần về cụ thể từng ngày như sau</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="loto2_detail" style="width:240px;float:left;">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                       
                                        <col width="100px">
                            ...
                            <div class="loto3_detail" style="width:240px;float:left;display:none">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                       
                                        <col width="100px">
                            ...
                            <div class="loto4_detail" style="width:240px;float:left;display:none">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                      
                                        <col width="100px">
                            ...
                            <div class="loto5_detail" style="width:240px;float:left;display:none">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                        
                                        <col width="100px">
                            ...
                            <div class="loto6_detail" style="width:240px;float:left;display:none">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                        
                                        <col width="100px">
                            ...
                            <div class="loto7_detail" style="width:240px;float:left;display:none">
                                <table class="sc-table-tsc">
                                    <colgroup>
                            ...
                            <div class="loto8_detail" style="width:240px;float:left;display:none">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                        
                                        <col width="100px">
                            ...
                            <div class="loto9_detail" style="width:240px;float:left;display:none">
                                <table class="sc-table-tsc">
                                    <colgroup>
                                        <col width="40px">                        <col width="80px">
                                        <col width="100px">
