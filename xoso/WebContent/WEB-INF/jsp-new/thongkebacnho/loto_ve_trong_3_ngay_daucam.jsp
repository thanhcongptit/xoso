...
<html lang="en">
    <head>
        ...
        <%
            ...
            String typeSub = (String) request.getAttribute("typeSub");
            ...
            if (!CommonUtil.isEmptyString(special)) {
                ...
                if (typeSub.equals("2")) {
                    LotoDauCamDTO lotoDauCamDTO = camBus.getLotoDauCam(date, Integer.parseInt(numberDate), special);
                    awards = lotoDauCamDTO.getOpenDates();
                    results = lotoDauCamDTO.getResult();
                } else {
                    LotoDauCamBachthuDTO lotoDauCamBachthuDTO = camBus.getLotoDauCamBachThu
                    		(date, Integer.parseInt(numberDate), special);
                    awards = lotoDauCamBachthuDTO.getOpenDateDTOs();
                    results1 = lotoDauCamBachthuDTO.getResults();
                }
            }
        %>
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, Lotto về trong 3 ngày theo đầu câm)</h1>
                </div>
            </section>

            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/dau_cam_loto_rs.htm" accept-charset="UTF-8" class="" name="frm" autocomplete="off"><input name="_token" type="hidden" value="FliiCwtWxloRDGOEX1YgnmIIX9Bp9eWxhQJml2mn">
            ...
            <section class="sc-section">
                ...
                <center>
                    <div class="tb-tsc">
                        <p><center>Thống kê  trong <%=numberDate%> lần câm đầu <%=special%> về gần đây, 10 cặp loto về nhiều nhất trong 3 ngày sau đó:</center></p>
                        <br />
                        <br />
