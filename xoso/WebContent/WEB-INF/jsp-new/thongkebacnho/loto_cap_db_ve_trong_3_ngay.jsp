...
<%@page import="com.soicaupro.thongkebacnho.domain.LotoDacBiet3NgayDTO"%>
...
<html lang="en">
	...
	href="css/main.css">
        ...
        <%
            ...
            List<ScreenThreeDaySpecialDTO> results = (List<ScreenThreeDaySpecialDTO>) request.getAttribute("results");
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, Lotto cặp về trong 3 ngày theo đặc biệt)</h1>
                </div>
            </section>

            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/loto_cap_db_rs_ve_trong_3ngay.htm" accept-charset="UTF-8" class="" name="frm" autocomplete="off"><input name="_token" type="hidden" value="FliiCwtWxloRDGOEX1YgnmIIX9Bp9eWxhQJml2mn">
            ...
            <section class="sc-section">
                ...
                <center>
                    <div class="tb-tsc">
                        <p><center>Thống kê từ 01/01/2005 đến nay trong <%=numberDate%> lần ĐB về <%=special%> gần đây, 10 cặp loto về nhiều nhất trong 3 ngày sau đó:</center></p>
                        <br />
                        <br />
