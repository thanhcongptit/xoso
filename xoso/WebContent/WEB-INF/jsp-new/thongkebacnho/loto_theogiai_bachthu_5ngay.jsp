...
<html lang="en">
	...
	href="css/main.css">
     <%
         ...
         if(!CommonUtil.isEmptyString(datetime)) {
        	 results = new LotoTheoGiaiBachThuBus().getListLotoTheoGiaiDTOs
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, Lotto bạch thủ về trong 5 ngày theo giải)</h1>
                </div>
            </section>

            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/theogiai_rs_bachthu_5_ngay.htm" accept-charset="UTF-8" class="frm" name="frm" autocomplete="off">
