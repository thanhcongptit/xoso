...
<html lang="en">
	...
	href="css/main.css">
     <%
         ...
         if(!CommonUtil.isEmptyString(datetime)) {
        	 results = new LotoTheoBo2BachthuBus().getListLotoBo2BachThu
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, Loto về theo bộ 2 loto về cùng nhau)</h1>
                </div>
            </section>

            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/bo2_bachthu_rs.htm" accept-charset="UTF-8" class="frm" name="frm" autocomplete="off">
