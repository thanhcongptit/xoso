	...
	href="css/main.css">
        ...
        <%
            ...
            if (!CommonUtil.isEmptyString(indexLoto)) {
				...
				LotoNhieuNhayDTO lotoNhieuNhayDTO = nhieuNhayBus.getListDateNhieuNhay
						(Integer.parseInt(indexLoto), date, Integer.parseInt(soNhay), Integer.parseInt(numberDate));
				
                awards = lotoNhieuNhayDTO.getOpenDates();
                results = lotoNhieuNhayDTO.getResult();
            }
        %>
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, loto về theo loto về nhiều nháy)</h1>
                </div>
                <section class="sc-section">
            ...
            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/nhieu_nhay_loto_rs.htm" accept-charset="UTF-8" class="" name="frm" autocomplete="off"><input name="_token" type="hidden" value="FliiCwtWxloRDGOEX1YgnmIIX9Bp9eWxhQJml2mn">
                        ...
                        &nbsp lần &nbsp Loto  
                        <select name="indexLoto" class="form-control" id="dacBiet">
                            <%
                                int temp = 45;
                                if (!CommonUtil.isEmptyString(indexLoto)) {
                        ...
                        &nbsp về từ &nbsp
                   		...
                   		<select name="soNhay" class="form-control" id="dacBiet">
                   			<%for(int i = 1; i <= 4; i++) {%>
                   				<option value="<%=i%>" <%if (soNhay.equals(String.valueOf(i))) {%> selected= <%}%> ><%=i%></option>
                   			<% }%>
                   		</select>
                   		 &nbsp nháy gần đây &nbsp
            ...
            <section class="sc-section">
                ...
                <center>
                    <div class="tb-tsc">
                        <p><center>Thống kê  trong <%=numberDate%> lần loto <%= Constant.coupleLoto[index][0]%>,<%= Constant.coupleLoto[index][1]%> về từ <%=soNhay %> nháy gần đây, 10 cặp loto về nhiều nhất trong 3 ngày sau đó:</center></p>
                        <br />
                        <br />
