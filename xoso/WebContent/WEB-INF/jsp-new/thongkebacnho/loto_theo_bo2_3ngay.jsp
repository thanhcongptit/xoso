...
<html lang="en">
	...
	href="css/main.css">
     ...
     <%
         ...
         if(!CommonUtil.isEmptyString(datetime)) {
        	 results = new LotoTheoBo2Bus().getListLotoBo2
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/bo2_loto_rs.htm" accept-charset="UTF-8" class="frm" name="frm" autocomplete="off">
