...
<html lang="en">
    <head>
        ...
        <%
            ...
            /* else {
                    Date dataDate = CommonUtil.convertStringToDate(datetime1);
                    if(dataDate.before(CommonUtil.convertStringToDate("01-01-2014"))) {
                            datetime1 = "01-01-2005";
                    }
            } */
            ...
            if (CommonUtil.isEmptyString(date_begin)) {
                date_begin = CommonUtil.addDate1(currentDate, -2);
            }
            ...
            if (beginDate.after(endDate) || endDate.after(CommonUtil.addDate2(beginDate, 1))) {
                date_begin = CommonUtil.addDate1(endDate, -1);
            }
            ...
            if (!CommonUtil.isEmptyString(datetime1)) {
                results = new LotoTheoBo3Ngay3Bus().getListLotoBo3_3Ngay(date_begin, date_end, datetime1, Integer.parseInt(miss));
            }
            ...
            <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
                ...
                <section class="sc-section">
                    <div class="tkv-content">
                        <h1 class="sc-tt">(Soi cầu PRO, Loto về theo bộ 3 loto về cùng nhau)</h1>
                    </div>
                </section>

                <section class="sc-section"> 
                    <div class="sc-grp-columb input-prepend">
                        <form method="POST" action="${pageContext.servletContext.contextPath}/bo3_loto_rs.htm" accept-charset="UTF-8" class="frm" name="frm" autocomplete="off">
                        Thống kê dữ liệu từ <input type="text" name="datetime1" id="datetime1" <%if (CommonUtil.isEmptyString(datetime1)) { %> value="01-01-2005"<% } else {%> value="<%=datetime1%>"<%}%> class="form-control" style="width:100px">
                    ...
                    <p style="color:red">
                        - Chỉ lọc kết quả những bộ 3 lotto về cùng nhau >= 20 <br/>
                        - Dữ liệu được thống kê từ 01/01/2005 <br/>
                        Chú ý : Mỗi lần chỉ xem được tối đa 2 ngày .
                    ...
                    <table class="sc-table-tsc">
                        ...
                        <tr>
                            ...
                            <% for (LotoTheoGiaiDetailDTO detailDTO : detailDTOs) {%>
                                <td style="<% if (detailDTO.getColorDay().equals("1")) {%> background-color:#FFCC66; <%} else if (detailDTO.getColorDay().equals("2")) {%>background-color:#99CC00 <% } else if (detailDTO.getColorDay().equals("3")) {%>background-color:#99FF66 <% }%>"><%=detailDTO.getRs()%></td>
                            <%}%>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#date_end,#date_begin,#datetime1').datepicker({
                autoclose: true,
                format: "dd-mm-yyyy",
                todayHighlight: true,
                language: 'vi'
