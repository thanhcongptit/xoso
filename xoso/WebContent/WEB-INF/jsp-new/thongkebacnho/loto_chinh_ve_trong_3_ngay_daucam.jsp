	...
	href="css/main.css">
        ...
        <%
            ...
            if (!CommonUtil.isEmptyString(special)) {
            	LotoDauCamBachthuDTO lotoDauCamBachthuDTO = new LotoCamBus().getLotoDauCamChinhBachThu
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, Lotto chính về trong 3 ngày theo đầu câm)</h1>
                </div>
            </section>

            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/dau_cam_chinh_rs.htm" accept-charset="UTF-8" class="" name="frm" autocomplete="off"><input name="_token" type="hidden" value="FliiCwtWxloRDGOEX1YgnmIIX9Bp9eWxhQJml2mn">
