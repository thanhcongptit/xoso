    ...
    <head>
        ...
        <%
            ...
            if (!CommonUtil.isEmptyString(special)) {
                ...
                if (typeSub.equals("2")) {
                   LotoDauCamDTO camDTO = new LotoDauCamDTO();	
                   camDTO = camBus.getLotoDuoiCam(date, Integer.parseInt(numberDate), special);
                   awards = camDTO.getOpenDates();
                   results = camDTO.getResult();
                   
                } else {
                	LotoDauCamBachthuDTO camDTO = new LotoDauCamBachthuDTO();	
                    camDTO = camBus.getLotoDuoiCamBachThu(date, Integer.parseInt(numberDate), special);
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section">
                <div class="tkv-content">
                    <h1 class="sc-tt">(Soi cầu PRO, Lotto về trong 3 ngày theo đuôi câm)</h1>
                </div>
            </section>

            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/duoi_cam_loto_rs.htm" accept-charset="UTF-8" class="" name="frm" autocomplete="off"><input name="_token" type="hidden" value="FliiCwtWxloRDGOEX1YgnmIIX9Bp9eWxhQJml2mn">
            ...
            <section class="sc-section">
                ...
                <center>
                    <div class="tb-tsc">
                        <p><center>Thống kê  trong <%=numberDate%> lần câm đuôi <%=special%> về gần đây, 10 cặp loto về nhiều nhất trong 3 ngày sau đó:</center></p>
                        <br />
                        <br />
                                ...
                                <table class="sc-table-tsc">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="background-color:#FF9900;padding:16px 0 15px 0">Đuôi câm</td>
