    ...
    <head>
     ...
     <%
         ...
         if(!CommonUtil.isEmptyString(datetime)) {
        	 results = new LotoTheoBo3BachthuBus().getListLotoBo3BachThu
        ...
        <div id="tkv-wrapper" class="fix-clear"><!-- Bắt đầu phần thân -->
            ...
            <section class="sc-section"> 
                <div class="sc-grp-columb input-prepend">
                    <form method="POST" action="${pageContext.servletContext.contextPath}/bo3_bachthu_rs.htm" accept-charset="UTF-8" class="frm" name="frm" autocomplete="off">
