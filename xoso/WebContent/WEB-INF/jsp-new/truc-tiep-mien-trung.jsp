    ...
    <head>
        ...
        <script>
            ...
            function checkTimeLive() {
                ...
                if (currHHMMSS >= 171000 && currHHMMSS < 173800) {
                    if (hourmt === '00' && minumt === '00' && secondmt === '00') {
                        hidenKQ('#kqmientrung');
                        hidenKQ('#d2mientrung');
                    }
                            ...
                            <table>
                                ...
                                <c:if test="${lotterysMT!=null&&numSizeMT>0}">
                                    ...
                                    <div class="box_kqxs box_cc" id="kqmientrung">
                                        <div id="kqxsmb">
                                            <div class="result-header">                           
                                                <h2 ><a href="${strUrl}/ket-qua-xo-so-binh-dinh-xsbdh.html" title="kết quả xổ số miền trung">KẾT QUẢ XỔ SỐ MIỀN TRUNG XSMT</a> Ngày ${lotterysMT.openDate}</h2>                       
                                            </div>                       
                                            <div class="box_so">
                                                <table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#dedede">
                                                    <tbody>
