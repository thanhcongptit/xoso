                            ...
                            <c:if test="${listCaulotoDetail!=null}">   
                                ...
                                <tr>
                                    <td style="padding-top: 25px;font-size: 13px;font-weight: bold">
                                        <p style="width: 615px;word-wrap: break-word;">${caulotodetail.loto}</p>
                                    </td>
                                </tr>    
                                <tr>
                                    <td style="padding-top: 25px">
                                        <c:if test="${code=='XSTD'}">
                                            ...
                                            <table width="100%" class="bot" cellspacing="0" cellpadding="0" style="text-align: center;font-weight: bold;font-size: 15px;">
                                                <tr style="height: 30px">                                                
                                                    <td class="bol"  colspan="13">
                                                        <div class="result-header">
                                                            <h2>Xổ số Miền Bắc Ngày ${caulotodetail.lotteryResult.open_date}</h2>
                                                        </div>
                                                    </td>
                                                </tr>
