<%-- 
    Document   : content-tkranhieu30ngay
    Created on : 14-Jan-2016, 09:25:24
    Author     : 24h
--%>
...
<!DOCTYPE html>
<div id="tkranhieu30ngay">
    <h2 class="h1title">Thống kê loto ra nhiều trong 30 ngày</h2>
    <c:if test="${max30LotoList != null}">
        <table border="0" cellspacing="0" cellpadding="0" class="bot" style="display: inline-table;">
            ...
            <tbody>
                <c:forEach items="${max30LotoList}" var="loto" varStatus="i">
