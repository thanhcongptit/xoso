            ...
            <div id="main_container">
                ...
                <div id="content">
                    ...
                    <div id="content-center"> 
                        <table style="font-weight: bold;font-size: 15px;border-color: #aaa" width="100%" border="1" cellspacing="0" cellpadding="0">
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: center;padding-top: 5px">
                                    <form method="post">
                                        ...
                                        <input type="checkbox" value="0" name="opt" <c:if test="${opt=='0'}">checked</c:if> />
                            ...
                            <c:if test="${listLoto!=null}">
                                ...
                                <fmt:parseNumber var="ngaychuave" value="0" type="number"/>
                                <c:set var="lotomax" value=""/>
                                <c:set var="lotochuave" value=""/>
                                <c:forEach items="${listLoto}" var="loto">
                                    ...
                                    <c:if test="${loto.ngaychuave > ngaychuave}">
                                        <fmt:parseNumber var="ngaychuave" value="${loto.ngaychuave}" type="number"/>
                                        <c:set var="lotochuave" value="${loto}"/>
                                    </c:if>
                                </c:forEach>
                                <tr>
                                ...
                                <tr>
                                    <td style="line-height: 20px">Điểm gan đến nay là :  <span style="color: red">${ngaychuave}</span> ngày (Không tính ngày về gần nhất, ngày về gần nhất cả dàn là: ${lotochuave.ngayxuathiengannhat})</td>
                                </tr>
                            </c:if>
                        </table>
