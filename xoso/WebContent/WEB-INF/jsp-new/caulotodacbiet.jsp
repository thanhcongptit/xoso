                ...
                <div id="content">
                    ...
                    <div id="content-center"> 
                        <table width="100%" border="1" style="border-color: #aaa" cellspacing="0" cellpadding="0">
                            <tr>
                                <td><h2 class="h1title" style="text-align: center">THỐNG KÊ CẦU LOTO ĐẶC BIỆT</h2></td>
                            </tr>
                            <tr>
                                <td style="padding-top: 10px;text-align: center">
                                    ...
                                    <br/><br/>
                                    <input type="checkbox" value="1" name="cham" <c:if test="${cham=='1'}">checked</c:if>/>gần giải đặc biệt hơn
                                    <br/><br/>
                                    Miền bắc
                                                ...
                                                <tr style="height: 30px">
                                                    ...
                                                    <td  class="bol" style="height:30px;width: 50px">                                                        
                                                        <c:if test="${cauloto.cau>=icau}">
                                                            <a href="${pageContext.servletContext.contextPath}/detailcau.htm?code=${code}&d=${tungay}&l=${cauloto.loto}&v1=${cauloto.vitri1}&v2=${cauloto.vitri2}&c=${cau}" target="_bank">${cauloto.loto}</a>
                                                        </c:if>
