            ...
            <div class="content">
                <div class="formWrapper">
                    ...
                    <div style="margin-bottom: 5px;">
                        <a class="btnCMS" href="<%= request.getContextPath() %>/admin/news/create.htm">Thêm mới</a>
                    </div>
                    <div class="form1">
                        <%
                            int rowsPerPage = 10;
                        ...
                        <table class="info" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><%= news.getTitle() %></td>
                                <td><img src="<%= news.getImageUrl()%>" width="100"/></td>
                                ...
                                <td>
                                    ...
                                    %>                                    
                                    | <a href="<%= request.getContextPath() %>/admin/news/update.htm?id=<%= news.getId() %>">Sửa</a>
