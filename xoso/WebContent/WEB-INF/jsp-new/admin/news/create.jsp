                        ...
                        <form method="post">
                            <table class="table-auto">
                                <tr>
                                    <td>Tiêu đề</td>
                                    <td>
                                        <input name="title"/> (tối đa 150 ký tự)
                                    </td>
                                </tr>
                                <tr>
                                    <td>Link ảnh đại diện</td>
                                    <td>
                                        <input style="width: 250px;" name="imageURL"/> <br/><br/>(vd: http://domain.com/upload/thumb-nail.jpg)
                                    </td>
                                </tr>
                                <tr>
                                    <td>Mô tả</td>
                                    <td>
                                        <textarea style="border: solid 1px #0b9444;min-width: 143px;padding: 5px;" name="desc" rows="5" cols="25"></textarea>
                                        (tối đa 200 ký tự)
                                    </td>
                                </tr>
                                <tr>
