...
<div class="header">
    <div class="nav_top">
        <a href="<%= request.getContextPath() %>/admin" class="logo">SOICAUPRO.COM CMS</a>
        <ul>
            <% 
                if(adminOnl.getRight() == Admin.RIGHT_ADMIN){
            %>
                <li>
                    <a href="<%= request.getContextPath() %>/admin/member/index.htm">Quản lý thành viên</a>
                </li>
                <li>
                    <a href="<%= request.getContextPath() %>/admin/news/index.htm">Quản lý Tin XS</a>
                </li>
                <li>
                    <a href="<%= request.getContextPath() %>/admin/du/index.htm">Dự đoán</a>
                </li>
                <li>
                ...
                <li>
                    <a href="<%= request.getContextPath() %>/admin/lien-he/index.htm">Quản lý Liên hệ</a>
                </li>
                <li>
                    <a href="<%= request.getContextPath() %>/admin/cau-hinh/index.htm">Quản lý Cấu hình</a>
                </li>
