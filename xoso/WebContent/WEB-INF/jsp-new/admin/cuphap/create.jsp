            ...
            <%
                ...
                if("create".equals(action)){
                    ...
                    if("".equals(content)){
                        ...
                        if(newsDAO.createCuphap(smsDTO)){
                            msg = "<span style='color:green'>Tạo cú pháp thành công!</span>";
                        }else{
                            msg = "Tạo tin cú pháp thất bại!";
                        }
                    }
                }
            %>
                        ...
                        <form method="post">
                            <table class="table-auto">
                                ...
                                <tr>                                    
                                    ...
                                    <td><a href="<%= request.getContextPath() %>/admin/cuphap.htm" class="btnCMS">Trở về</a></td>
                                </tr>
                            </table>
                        </form>
                    </div>
