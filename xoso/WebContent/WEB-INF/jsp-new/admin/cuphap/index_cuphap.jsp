        ...
        <div class="container">
            ...
            <div class="content">
                <div class="formWrapper">
                    <h1>Quản lý Cú pháp</h1>
                    <div style="margin-bottom: 5px;">
                        <a class="btnCMS" href="<%= request.getContextPath() %>/admin/cuphap/create.htm">Thêm mới</a>
                    </div>
                    <div class="form1">
                        <%
                            ...
                            System.out.println("size cu phap : " + smsDTOs.size());
                        %>
                        <%
                            SmsDTO news = null;
                            if(smsDTOs != null){
