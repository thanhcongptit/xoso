...
import static xs.parsing.kq.KQParsingXS.getListKQ;
import static xs.parsing.kq.KQParsingXS.parseDate;

/**
 *
 * @author 24h
 */
public class TKVParsingXS {
    ...
    public static void main(String[] args) throws IOException {        
        ...
        Elements elements = doc.select("table[class~=sc-table-result]");
        ...
        for(Element table : elements){
            ...
            i = 1;
            lottery.setOpenDate(parseDate(table.parent().parent().previousElementSibling().text()));
        ...
        System.out.println("size list="+listLottery.size());
        LotteryResultDAO lotteryResultDAO = new LotteryResultDAO();
        if(!listLottery.isEmpty()) for(LotteryResult lottery1 : listLottery){
            lottery = lottery1;
