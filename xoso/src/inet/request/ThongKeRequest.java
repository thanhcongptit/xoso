...
import inet.model.ThongKeLotoDAO;
...
public class ThongKeRequest {
    ...
    //-------------------------------------------------------------------------
    public List<PhantichLoto> parserPhanTichLoTo(String startdate,String lon,String nhay,String cau,String maxcau){
        try{
            Gson gson=new Gson();        
            ...
            if(string.contains("list")){
                ...
                return fillterPhanTichLoto(phantichLotoJson.getList(),iCau);
            }
        }catch(Exception e){
...
//            }
            if(code!=null&&!"".equals(code)){
                if(numOfWeek!=null&&!"".equals(numOfWeek)){
                    ThongKeLotoDAO thongKeLotoDAO=new ThongKeLotoDAO();
                    thongKeLotoDAO.thongkeCapsoDao(code, Integer.parseInt(numOfWeek));
                    List<CapSo> list=orderLoto(thongKeLotoDAO.getDanhsachCapso(), order);
                    return list;
                }
            }                        
...
//            }
    ...
    public static void main(String [] arg){
        ...
        List<CapSo> list=thongKeRequest.parserThongKeLotoCapSo("XSTD","10","");
        if(list!=null){
            System.out.println("do dai list "+list.size());
            System.out.println("--------"+list.get(0).getCapso());
        }else{
