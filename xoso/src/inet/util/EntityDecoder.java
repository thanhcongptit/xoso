...
public class EntityDecoder {    
  ...
  public static String charToHtml (String raw) {
   ...
   public static String convertHtmlEntityToChar(String htmlEntity){
	   for(int i = 0; i < charsHtml.length; i++){
		   htmlEntity = htmlEntity.replace(charsHtml[i], chars[i]);
	   }
	   return htmlEntity;
   }   
   public static void main(String[] args) {
	   String str = "Ph&ugrave;ng Thị Th&uacute;y Nga";
	   System.out.println(EntityDecoder.convertHtmlEntityToChar(str));
   }
}