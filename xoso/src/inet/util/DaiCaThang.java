...
public class DaiCaThang {
	...
	public static String[] fuck69(String source){
		if(source == null || "".equals(source)) return null;
		String tmp = toUrlFriendly(source).replace("-", "").toUpperCase();
		String[] rs = new String[tmp.length()];
...
//		String rs[] = DaiCaThang.fuck69("Trịnh    Lê Tú");
//		System.out.println(DaiCaThang.fuck69("Trịnh    Lê Tú").length);
//		for(String s : rs){
//			System.out.print(s);
//		}
		System.out.println(toUrlFriendly("Phương Pháp Bắt Bạch Thủ").toLowerCase());
	}
}
