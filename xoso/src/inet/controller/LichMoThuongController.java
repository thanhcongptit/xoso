 ...
 * @author hanhlm
 */
public class LichMoThuongController extends BaseController {
    
    public LichMoThuongController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        if("pc".equalsIgnoreCase(strMobile)){mod.setViewName("/lichmothuong");}
        else{mod.setViewName("/mobile/lichmothuong");}
