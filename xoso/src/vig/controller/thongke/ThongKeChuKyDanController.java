 ...
 * @author HanhDung
 */
public class ThongKeChuKyDanController extends BaseController {

    private static HashMap<String, Object> hMap = null;
    private static String sDDMMYYYY = null;

    public ThongKeChuKyDanController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        if(opt==null||"".equals(opt)){opt="1";}
        
        
        
        List<Loto> listLoto = null;
        if (danloto != null && !"".equals(danloto)) {
            String key=tungay+denngay+danloto+opt;
