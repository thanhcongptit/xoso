...
public class BangTanSuat {
        ...
        if (listLottery != null && !listLottery.isEmpty()) {
            ...
            for (int i = 0; i < listLottery.size(); i++) {
                ...
                for (int j = 0; j < 10; j++) {
                    ...
                    tanSuat.setOpenDate(lotteryResult.getOpen_date());
    ...
    public List<List<TanSuat>> findTanSuatTheoThu(String code, String thu, String sDate, String eDate) {
        ...
        if (listLottery != null && !listLottery.isEmpty()) {
            ...
            for (int i = 0; i < listLottery.size(); i++) {
                lotteryResult = listLottery.get(i);
                tmpThu = DatePro.getDateOfWeek(lotteryResult.getOpen_date());
    ...
    private Loto getNhipTuanSuat(LotteryResult lotteryResult, String capso) {
        ...
        if (!"".equals(strGiai)) {
            ...
            loto.setLoto(capso);
            loto.setNgayxuathiengannhat(lotteryResult.getOpen_date());
            loto.setThuve(DatePro.convertDayOfWeek(DatePro.getDateOfWeekDDMMYYYY(lotteryResult.getOpen_date())));
        }
        ...
        if (list != null && !list.isEmpty()) {
            for (int i = 0; i < list.size(); i++) {
                ...
                for (TanSuat tanSuat : listTanSuat) {
                    System.out.println(tanSuat.getSolanve());
                }
            }
        }
    }
