...
public class ThongKeDacBiet {
    ...
    public List<DacBiet> findBangDacBiet(String code, String sDate, String eDate) {
        ...
        for (int i = 0; i < listLottery.size(); i++) {
            ...
            dacBiet.setNgayve(lotteryResult.getOpen_date());
            dacBiet.setThu(DatePro.convertDayOfWeek(DatePro.getDateOfWeekDDMMYYYY(lotteryResult.getOpen_date())));
    ...
    public static void main(String[] args) {
        ...
        List<Loto> list = thongKeDacBiet.findLotoDanDacBiet("XSTD", "2009-07-01", "2015-12-31", "00,01");
        if (list != null && !list.isEmpty()) {
            Loto loto = null;
            for (int i = 0; i < list.size(); i++) {
                loto = list.get(i);
                System.out.println(loto.getLoto() + "|" + loto.getNgayxuathiengannhat() + "|" + loto.getNgaychuave() + "|" + loto.getGanmax());
            }
        }
    }
}
