...
public class LotoTheoBo4BachthuBus {
	
	private List<LotoTheoGiaiBachThuDTO> lotoTheoBos = new ArrayList<LotoTheoGiaiBachThuDTO>();

	public List<LotoTheoGiaiBachThuDTO> getListLotoBo4BachThu(String toDate, String dataDate, int miss) {
...
//			}
	...
	public static void main(String arg[]) {
		new LotoTheoBo4BachthuBus().getListLotoBo4BachThu("15-03-2016", "01-01-2005", 0);
