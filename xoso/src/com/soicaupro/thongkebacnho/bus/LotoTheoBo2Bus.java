...
public class LotoTheoBo2Bus {
	
	private List<LotoTheoGiaiDTO> lotoTheoBos = new ArrayList<LotoTheoGiaiDTO>();

	public List<LotoTheoGiaiDTO> getListLotoBo2(String fromDate, String toDate, String dataDate, int miss) {
...
//		}
			...
			if(dates != null && dates.size() >= 20) {
				...
				for (int t = 0; t < 50; t++) {
					LotoTheoGiaiDTO lotoTheoGiaiDTO = getLotoGiaiDTO(cacgiai,
							giai1.getValue(), giai2.getValue(), dates, giai1.getOpen_date(), Constant.coupleLoto[t]);
	...
	private LotoTheoGiaiDTO getLotoGiaiDTO(AwardDetailDTO[][] cacgiai,
			String giai1, String giai2, List<java.sql.Date> dates, java.sql.Date openDate, String loto[]) {
	...
	public static void main(String arg[]) {
		new LotoTheoBo2Bus().getListLotoBo2("06-02-2016", "09-02-2016", "01-01-2014", 0);
