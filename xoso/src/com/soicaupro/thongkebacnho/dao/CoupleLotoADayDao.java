 ...
 * @author conglt
 */
public class CoupleLotoADayDao {
	Logger logger = null;
	private DBPoolX poolX = null;

    public CoupleLotoADayDao() {
    ...
    public List<ResultOneDayDTO> getCoupleLoto(List<SpecialAwardDTO> awards, String[] couple, int day) {
    ...
    public List<ResultOneDayDTO> getLoto(List<SpecialAwardDTO> awards, String loto, int day) {
