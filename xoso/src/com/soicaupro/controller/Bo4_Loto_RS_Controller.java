 ...
 * @author conglt
 */
public class Bo4_Loto_RS_Controller extends BaseController{
    ...
    protected ModelAndView handleRequestInternal(
        ...
        String datetime1 = "01-01-2005";
        mod.addObject("datetime", datetime1);
        mod.addObject("date_begin", date_begin);
        mod.addObject("date_end", date_end);
        mod.addObject("miss", miss);
        
        System.out.println("rs bo 4:" + datetime1 + "--" + date_begin );
        
        mod.setViewName("thongkebacnho/loto_theo_bo4_3ngay");
