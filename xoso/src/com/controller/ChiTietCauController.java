 ...
 * @author hanhlm
 */
public class ChiTietCauController extends BaseController {
    
    private static String sDDMMYYYY=null;
    private static HashMap<String,Object> hMap=null;
    
    public ChiTietCauController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        if(cau!=null&&!"".equals(cau)&&loto!=null&&!"".equals(loto)
            ...
            String key=cau+loto+vitri1+vitri2+tungay+code;
        ...
        mod.addObject("title", "CHI TIẾT KẾT QUẢ CẦU");
        return mod;
    }
    ...
    private List<CauLotoDetail> crawLotteryResult(List<LotteryResult> list, String v1,String v2,String cau,String code){
        ...
        for (int i = 0; i < iCau; i++) {
                ...
                if(i<iCau){
                    ...
                    caplotodao=loto.substring(iV1,iV1+1);
                    caplotodao=loto.substring(iV2,iV2+1)+caplotodao;
                }
                ...
                if(!"".equals(loto)){
                    cauLotoDetail.setLoto(StringConvert.lotoResult(lotteryResult).replaceAll("-", ",&nbsp;").replace(caploto, "<span style=\"color: red\">"+caploto+"</span>").replace(caplotodao, "<span style=\"color: red\">"+caplotodao+"</span>"));
                }else{
